...
public class ComicVineGetIssueDetailsActionTest {
  ...
  public void setUp() throws IOException, KeyStoreException, NoSuchAlgorithmException {
    scrapeComicAction.setBaseUrl(ComicVineMetadataAdaptor.BASE_URL);
  ...
  public void testExecuteGetIssueDetailsThrowsException() throws MetadataException {
    Mockito.when(detailsAction.execute()).thenThrow(MetadataException.class);
  ...
  public void testExecuteGetVolumeDetailsThrowsException() throws MetadataException {
    ...
    Mockito.when(volumeDetailsAction.execute()).thenThrow(MetadataException.class);
  ...
  public void testExecuteGetPublisherDetailsThrowsException() throws MetadataException {
    ...
    Mockito.when(publisherDetailsAction.execute()).thenThrow(MetadataException.class);
  ...
  public void testExecute() throws MetadataException {
    ...
    final IssueDetailsMetadata result = scrapeComicAction.execute();
  ...
  private void verifyGetIssueDetailsAction() throws MetadataException {
    ...
    Mockito.verify(detailsAction, Mockito.times(1)).setBaseUrl(ComicVineMetadataAdaptor.BASE_URL);

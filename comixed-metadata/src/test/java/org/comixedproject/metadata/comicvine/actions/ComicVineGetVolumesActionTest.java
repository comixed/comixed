...
public class ComicVineGetVolumesActionTest {
  ...
  private static final String TEST_IMAGE_URL =
      "https://comicvine1.cbsistatic.com/uploads/original/0/2/80536-18005-105403-1-action-comics.jpg";
  ...
  @Test(expected = MetadataException.class)
  public void testExecuteMissingSeries() throws MetadataException {
  ...
  public void testExecute() throws MetadataException {
    ...
    final List<VolumeMetadata> result = getVolumesAction.execute();

    assertNotNull(result);
    assertFalse(result.isEmpty());
    assertEquals(TEST_ALL_RECORDS.intValue(), result.size());

    final VolumeMetadata volume = result.get(0);

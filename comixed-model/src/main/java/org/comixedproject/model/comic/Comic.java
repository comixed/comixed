...
public class Comic {
  ...
  @JsonView({View.ComicListView.class, View.LibraryUpdate.class})
  @Getter
  @Setter
  ...
  @JsonView({View.ComicListView.class, View.DuplicatePageList.class, View.LibraryUpdate.class})
  @Getter
  @Setter
  ...
  @JsonProperty("pages")
  @JsonView({View.ComicDetailsView.class, View.LibraryUpdate.class})
  @Getter

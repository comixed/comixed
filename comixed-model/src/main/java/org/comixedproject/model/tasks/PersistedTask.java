...
/**
 * <code>PersistedTask</code> represents a persisted worker task.
 *
...
public class PersistedTask {
  ...
  @OneToMany(
      ...
      orphanRemoval = true)
  @JsonIgnore
  private Set<PersistedTaskProperty> properties = new HashSet<>();
  ...
  public void setProperty(final String name, final String value) {
    this.properties.add(new PersistedTaskProperty(this, name, value));
  }
  ...
  public String getProperty(final String name) {
    for (int index = 0; index < this.properties.size(); index++) {
      PersistedTaskProperty property = (PersistedTaskProperty) this.properties.toArray()[index];

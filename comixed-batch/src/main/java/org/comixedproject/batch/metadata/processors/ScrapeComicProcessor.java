...
/**
 * <code>ScrapeComicProcessor</code> performs the work of actually loading and applying metadata to
 * a comic.
 *
...
@Component
@Log4j2
public class ScrapeComicProcessor implements ItemProcessor<Comic, Comic>, StepExecutionListener {
  ...
  public Comic process(final Comic comic) throws Exception {
    ...
    result.setBatchUpdatingMetadata(false);
    return result;
  }

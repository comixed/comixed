...
@StepScope
@Log4j2
public class UpdateMetadataChunkListener extends AbstractBatchProcessChunkListener<Comic, Comic> {
  @Override
  ...
  protected boolean isActive() {
    return this.comicService.getUpdateMetadataCount() > 0L;
  }

  @Override
  protected long getProcessedElements() {
    return this.comicService.getComicCount() - this.comicService.getUpdateMetadataCount();
  }

...
/**
 * <code>MarkBlockedPagesReader</code> loads unprocessed comics that are waiting to have any blocked
...
public class MarkBlockedPagesReader extends AbstractComicReader {
  ...
  protected List<Comic> doLoadComics() {
    return this.comicService.findUnprocessedComicsForMarkedPageBlocking();
  }
}

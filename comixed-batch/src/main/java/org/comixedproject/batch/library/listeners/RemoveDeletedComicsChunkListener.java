...
/**
 * <code>RemoveDeletedComicsChunkListener</code> publishes status updates while removing comic books
 * marked for deletion.
 *
...
@StepScope
@Log4j2
public class RemoveDeletedComicsChunkListener
  ...
  protected boolean isActive() {
    return this.comicService.findComicsToPurgeCount() > 0L;
  }

  @Override
  protected long getProcessedElements() {
    return this.comicService.getComicCount() - this.comicService.findComicsToPurgeCount();
  }

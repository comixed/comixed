...
public class MoveComicReaderTest {
  private static final int MAX_RECORDS = 25;

  @InjectMocks private MoveComicReader reader;
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findComicsToBeMoved()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findComicsToBeMoved();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findComicsToBeMoved();
  }

...
public class RecreateComicFileReaderTest {
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findComicsToRecreate()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findComicsToRecreate();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findComicsToRecreate();
  }

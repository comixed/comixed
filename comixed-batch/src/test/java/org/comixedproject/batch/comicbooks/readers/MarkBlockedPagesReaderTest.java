...
public class MarkBlockedPagesReaderTest {
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findUnprocessedComicsForMarkedPageBlocking()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findUnprocessedComicsForMarkedPageBlocking();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findUnprocessedComicsForMarkedPageBlocking();
  }

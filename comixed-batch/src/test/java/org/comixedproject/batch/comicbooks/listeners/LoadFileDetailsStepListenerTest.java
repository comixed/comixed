...
public class LoadFileDetailsStepListenerTest {
  ...
  public void testBeforeStep() throws PublishingException {
    Mockito.when(comicService.getUnprocessedComicsWithoutFileDetailsCount())
    ...
    Mockito.verify(comicService, Mockito.times(1)).getUnprocessedComicsWithoutFileDetailsCount();

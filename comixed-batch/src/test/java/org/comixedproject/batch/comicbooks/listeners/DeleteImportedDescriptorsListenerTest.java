...
public class DeleteImportedDescriptorsListenerTest {
  ...
  public void setUp() throws PublishingException {
    ...
    Mockito.when(comicFileService.getUnimportedComicFileDescriptorCount())
        .thenReturn(TEST_COMIC_FILE_COUNT);
  ...
  public void testAfterStepAndCompleted() throws PublishingException {
    Mockito.when(comicFileService.getUnimportedComicFileDescriptorCount()).thenReturn(0L);

...
public class ContentsProcessedReaderTest {
  private static final int MAX_RECORDS = 25;

  @InjectMocks private ContentsProcessedReader reader;
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findProcessedComics()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findProcessedComics();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findProcessedComics();
  }

...
public class DeleteComicReaderTest {
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findComicsMarkedForDeletion()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findComicsMarkedForDeletion();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findComicsMarkedForDeletion();
  }

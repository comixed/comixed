...
public class LoadFileContentsReaderTest {
  private static final int MAX_RECORDS = 25;

  @InjectMocks private LoadFileContentsReader reader;
  ...
  public void testReadNoneLoadedManyFound() {
    ...
    Mockito.when(comicService.findUnprocessedComicsWithoutContent()).thenReturn(comicList);
    ...
    Mockito.verify(comicService, Mockito.times(1)).findUnprocessedComicsWithoutContent();
  }
  ...
  public void testReadNoneRemaining() {
    ...
    Mockito.verify(comicService, Mockito.never()).findUnprocessedComicsWithoutContent();
  }

...
public class CreateImageCacheEntriesReaderTest {
  ...
  public void testReadNoneLoaded() {
    ...
    Mockito.when(pageService.loadPagesNeedingCacheEntries(Mockito.anyInt())).thenReturn(pageList);
  ...
  public void testReadSomeRemaining() {
    ...
    Mockito.verify(pageService, Mockito.never()).loadPagesNeedingCacheEntries(Mockito.anyInt());
  }

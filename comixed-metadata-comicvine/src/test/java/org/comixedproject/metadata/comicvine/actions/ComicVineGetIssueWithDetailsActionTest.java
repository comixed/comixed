...
public class ComicVineGetIssueWithDetailsActionTest {
  ...
  @InjectMocks private ComicVineGetIssueWithDetailsAction action;
  ...
  public void testExecuteMissingBaseUrl() throws MetadataException {
    action.setBaseUrl("");
    action.execute();
  }
  ...
  @Test(expected = MetadataException.class)
  public void testExecuteMissingIssueId() throws MetadataException {
  ...
  public void testExecute() throws MetadataException {
    ...
    final ComicVineIssue result = action.execute();

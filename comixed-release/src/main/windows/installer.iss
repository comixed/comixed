...
LicenseFile=..\..\..\comixed-release-0.9.0-SNAPSHOT\LICENSE
OutputDir=..\..\..\target\
OutputBaseFilename=comixed-0.9.0-SNAPSHOT

[Files]
Source: "..\..\..\comixed-release-0.9.0-SNAPSHOT\bin\run.bat"; DestDir: "{app}\bin"
Source: "..\..\..\comixed-release-0.9.0-SNAPSHOT\bin\comixed-app-0.9.0-SNAPSHOT.jar"; DestDir: "{app}\bin"

...
:show_help
ECHO Usage: dbbackup.bat  -d [DATABASE] -j [URL] [OPTIONS]
ECHO.
ECHO OPTIONS:
...
java -cp %LIBDIR%/h2*jar org.h2.tools.Script -url jdbc:h2:file:%DATABASE% %OPTIONS% -script comixed-backup-1.6-SNAPSHOT.zip -options compression zip

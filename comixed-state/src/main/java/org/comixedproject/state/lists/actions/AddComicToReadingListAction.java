...
/**
 * <code>AddComicToReadingListAction</code> adds a comic to a reading list.
 *
 * @author Darryl L. Pierce
 */
@Component
@Log4j2
public class AddComicToReadingListAction extends AbstractReadingListAction {
  @Override
  public void execute(final StateContext<ReadingListState, ReadingListEvent> context) {
    ...
    readingList.getEntryIds().add(comicBook.getComicBookId());
  }
}

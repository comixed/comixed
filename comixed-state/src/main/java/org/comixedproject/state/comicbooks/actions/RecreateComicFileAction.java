...
/**
 * <code>RecreateComicFileAction</code> prepares a comic for being recreated.
 *
 * @author Darryl L. Pierce
 */
@Component
@Log4j2
public class RecreateComicFileAction extends AbstractComicAction {
  @Override
  public void execute(final StateContext<ComicState, ComicEvent> context) {
    ...
    log.trace("Setting the recreating flag");

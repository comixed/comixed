...
/**
 * <code>UpdateComicBookDetailsAction</code> prepares a comic book for having its details edited.
 *
 * @author Darryl L. Pierce
 */
@Component
@Log4j2
public class UpdateComicBookDetailsAction extends AbstractComicAction {
  @Override

...
/**
 * <code>AbstractPageAction</code> provides a foundation for building new actions for {@link
 * ComicPage} state events.
 *
 * @author Darryl L. Pierce
 */
@Log4j2
public abstract class AbstractPageAction extends StateContextAccessor
    implements Action<ComicPageState, ComicPageEvent> {}

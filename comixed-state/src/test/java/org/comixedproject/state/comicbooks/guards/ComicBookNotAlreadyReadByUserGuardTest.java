...
public class ComicBookNotAlreadyReadByUserGuardTest {
  @InjectMocks private ComicNotAlreadyReadByUserGuard guard;
  ...
  public void setUp() {
    ...
    Mockito.when(comicBook.getLastReads()).thenReturn(lastReadList);
    Mockito.when(lastRead.getUser()).thenReturn(user);
  }

  @Test
  public void testEvaluateAlreadyRead() {

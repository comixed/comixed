...
public class ConsolidateComicBookActionTest {
  @InjectMocks private ConsolidateComicAction action;
  ...
  public void testExecute() {
    ...
    Mockito.verify(comicBook, Mockito.times(1)).setConsolidating(true);
  }
}

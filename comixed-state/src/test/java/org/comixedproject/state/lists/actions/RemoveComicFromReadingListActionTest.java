...
public class RemoveComicFromReadingListActionTest {
  ...
  @Mock private List<Comic> readingListEntries;
  ...
  public void setUp() {
    ...
    Mockito.when(readingList.getComics()).thenReturn(readingListEntries);
  }
  ...
  public void execute() {
    ...
    Mockito.verify(readingListEntries, Mockito.times(1)).remove(comic);
  }
}

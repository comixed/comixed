...
export const ADD_SELECTED_COMICS_TO_READING_LIST_URL = `${API_ROOT_URL}/lists/reading/\${id}/comics/add/selected`;
export const REMOVE_SELECTED_COMICS_FROM_READING_LIST_URL = `${API_ROOT_URL}/lists/reading/\${id}/comics/remove/selected`;

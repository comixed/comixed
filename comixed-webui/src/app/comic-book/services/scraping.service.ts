...
import { LoadScrapingVolumesRequest } from '@app/comic-book/models/net/load-scraping-volumes-request';
import { LoadScrapingIssueRequest } from '@app/comic-book/models/net/load-scraping-issue-request';
import { Comic } from '@app/comic-book/models/comic';
import { ScrapeComicRequest } from '@app/comic-book/models/net/scrape-comic-request';

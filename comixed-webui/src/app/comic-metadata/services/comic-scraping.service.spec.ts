...
import { ComicScrapingService } from './comic-scraping.service';
import {
  DISPLAYABLE_COMIC_1,
  DISPLAYABLE_COMIC_2,
  DISPLAYABLE_COMIC_3,
...
describe('ComicScrapingService', () => {
  ...
  let service: ComicScrapingService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ComicScrapingService);

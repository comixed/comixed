...
} from '@app/settings/selectors/filename-scraping-rules.selectors';
...
} from '@app/settings/actions/filename-scraping-rules.actions';
import {
  CdkDragDrop,
  moveItemInArray,
  CdkDropList,
...
import { FILENAME_SCRAPING_RULE_TEMPLATE } from '@app/settings/settings.constants';

...
import { LibraryConfigurationComponent } from '@app/settings/components/library-configuration/library-configuration.component';
import { RouterTestingModule } from '@angular/router/testing';
import { MatTabsModule } from '@angular/material/tabs';
import { MatCardModule } from '@angular/material/card';
import { ServerRuntimeComponent } from '@app/settings/components/server-runtime/server-runtime.component';
import { MatExpansionModule } from '@angular/material/expansion';
import { FilenameScrapingRulesConfigurationComponent } from '@app/settings/components/filename-scraping-rules-configuration/filename-scraping-rules-configuration.component';
import { MatTableModule } from '@angular/material/table';
import { MatTooltipModule } from '@angular/material/tooltip';
import { MetadataSourceListComponent } from '@app/settings/components/metadata-source-list/metadata-source-list.component';
...
} from '@app/settings/reducers/filename-scraping-rules.reducer';
import { MatCheckboxModule } from '@angular/material/checkbox';
import { ServerMetricsComponent } from '@app/settings/components/server-metrics/server-metrics.component';
import { MatSelectModule } from '@angular/material/select';
import { ServerMetricDetailsComponent } from '@app/settings/components/server-metric-details/server-metric-details.component';
import {
  initialState as initialMetricState,
  METRICS_FEATURE_KEY
} from '@app/settings/reducers/metrics.reducer';
...
describe('ConfigurationPageComponent', () => {
  const OPTIONS = [
    ...
    { ...CONFIGURATION_OPTION_2, name: LIBRARY_FILE_NAMING_RULE },
    CONFIGURATION_OPTION_3,
    CONFIGURATION_OPTION_4,
    CONFIGURATION_OPTION_5
  ];

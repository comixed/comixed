...
export const LIBRARY_ORGANIZATION_CONFIG_URL = '/settings/configuration?tab=2';
...
export const DUPLICATE_PAGE_LIST_UPDATE_TOPIC =
  '/topic/duplicate-page-list.update';

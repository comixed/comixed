...
export const RUN_LIBRARY_PLUGIN_ON_ONE_COMIC_URL = `${API_ROOT_URL}/plugins/\${pluginId}/comics/\${comicId}`;
export const RUN_LIBRARY_PLUGIN_ON_SELECTED_COMICS_URL = `${API_ROOT_URL}/plugins/\${pluginId}/comics/selected`;

export const LIBRARY_PLUGIN_LIST_UPDATES = '/topic/plugin/list-update';

...
describe('CoverDateFilterPipe', () => {
  ...
  const COMIC_LAST_YEAR = { ...COMIC_1, coverDate: LAST_YEAR.getTime() };
  const COMIC_LAST_MONTH = { ...COMIC_3, coverDate: LAST_MONTH.getTime() };
  const COMIC_TODAY = { ...COMIC_5, coverDate: NOW.getTime() };

...
export const loadReadComicDetails = createAction(
  '[Comic Detail List] Load comic details for read comic books',
  props<{
    pageSize: number;
    pageIndex: number;
    sortBy: string;
...
export const loadDuplicateComicsDetails = createAction(

...
import { DeletedPageListPageComponent } from '@app/comic-pages/pages/deleted-page-list-page/deleted-page-list-page.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    component: DeletedPageListPageComponent,
    canActivate: [AdminGuard]
  },
  {

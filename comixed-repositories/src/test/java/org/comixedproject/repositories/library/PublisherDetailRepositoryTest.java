...
public class PublisherDetailRepositoryTest {
  @Autowired private PublisherDetailRepository repository;

  @Test
  public void testGetPublishers() {
    final List<PublisherDetail> result =
        repository.findAll(PageRequest.of(0, 10)).stream().toList();
  ...
  public void testGetPublisherCount() {
    final long result = repository.getPublisherCount();

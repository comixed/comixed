...
/**
 * <code>AuditableRestEndpointAspect</code> manages aspects relating to the REST APIs.
 *
...
@Configuration
@Log4j2
public class AuditableRestEndpointAspect {
   ...
   */
  @Around("@annotation(org.comixedproject.auditlog.rest.AuditableRestEndpoint)")
  public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
    Throwable thrownError = null;
    Object response = null;
    final MethodSignature signature = (MethodSignature) joinPoint.getSignature();
    final var annotation = signature.getMethod().getAnnotation(AuditableRestEndpoint.class);

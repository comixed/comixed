...
public class ComicFileHandlerTest {
  ...
  public void testLoadComicArchiveAdaptorException()
    ...
    Mockito.when(archiveType.getArchiveAdaptor()).thenReturn(archiveAdaptor);
    ...
    try {
      ...
      Mockito.verify(comic, Mockito.atLeastOnce()).getArchiveType();
      Mockito.verify(archiveType, Mockito.times(1)).getArchiveAdaptor();

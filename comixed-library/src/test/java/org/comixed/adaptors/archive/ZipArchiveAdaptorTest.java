...
public class ZipArchiveAdaptorTest {
    ...
    @Test(expected = ArchiveAdaptorException.class)
    public void testOpenFileIsDirectory()
            throws
            ArchiveAdaptorException {
    ...
    public void testLoadComic()
        ...
        assertEquals(4,
                     comic.getPageCount());
        assertEquals(TEST_FILE_ENTRY_0,
                     comic.getPage(0)
                          .getFilename());
        assertEquals(TEST_FILE_ENTRY_1,
                     comic.getPage(1)
                          .getFilename());
        assertEquals(TEST_FILE_ENTRY_2,
                     comic.getPage(2)
                          .getFilename());
        assertEquals(TEST_FILE_ENTRY_3,
                     comic.getPage(3)
                          .getFilename());
    }
    ...
    public void testGetSingleFile()
            throws
            ArchiveAdaptorException {
        byte[] result = archiveAdaptor.loadSingleFile(comic,
                                                      TEST_FILE_ENTRY_1);

        assertNotNull(result);
        assertEquals(7443280,
                     result.length);
    }

    @Test
    public void testGetSingleFileNotFound()
            throws
            ArchiveAdaptorException {
        byte[] result = archiveAdaptor.loadSingleFile(comic,
                                                      TEST_FILE_ENTRY_1.substring(1));
    ...
    @Test
    public void testSaveComicRenamePages()
            throws
            ArchiveAdaptorException {
        // load an existing comic
        archiveAdaptor.loadComic(comic);
        ...
        assertEquals(4,
                     result.getPageCount());
        assertEquals(TEST_FILE_ENTRY_RENAMED_0,
                     result.getPage(0)
                           .getFilename());
        assertEquals(TEST_FILE_ENTRY_RENAMED_1,
                     result.getPage(1)
                           .getFilename());
        assertEquals(TEST_FILE_ENTRY_RENAMED_2,
                     result.getPage(2)
                           .getFilename());
        assertEquals(TEST_FILE_ENTRY_RENAMED_3,
                     result.getPage(3)
                           .getFilename());
    }

    @Test
    public void testSaveComicDeletePages()
            throws
            ArchiveAdaptorException {
        // load an existing comic
        archiveAdaptor.loadComic(comic);
    ...
    @Test
    public void testGetFirstImageFileName()
            throws
            ArchiveAdaptorException {
        assertEquals(TEST_FILE_ENTRY_0,
                     archiveAdaptor.getFirstImageFileName(TEST_CBZ_FILE));
    }
    ...
    public void testLoadSingleFile()
            throws
            ArchiveAdaptorException {
        byte[] result = archiveAdaptor.loadSingleFile(TEST_CBZ_FILE,
                                                      TEST_FILE_ENTRY_1);
    ...
    @Test
    public void testEncodeFileToStream()
            throws
            ArchiveAdaptorException {
        Map<String, byte[]> content = new HashMap<String, byte[]>();
        content.put("file1",
                    "This is file one".getBytes());
        content.put("file2",
                    "This is file two".getBytes());

        byte[] result = archiveAdaptor.encodeFileToStream(content);

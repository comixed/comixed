...
public class ComicRepositoryTest {
    ...
    public void setUp()
            throws
            Exception {
        comic = repository.findById(TEST_COMIC)
                          .get();
    }
    ...
    public void testFilenameIsUpdatable() {
        ...
        Comic result = repository.findById(comic.getId())
                                 .get();
    ...
    public void testComicVineIdIsUpdatable() {
        String id = comic.getComicVineId()
                         .substring(1);
    ...
    public void testDateAddedCannotBeUpdated() {
        ...
        assertNotEquals(DateUtils.truncate(comic.getDateAdded(),
                                           Calendar.SECOND),
                        DateUtils.truncate(result.getDateAdded(),
                                           Calendar.SECOND));
    }
    ...
    public void testCoverDateCanBeUpdated() {
        ...
        assertEquals(DateUtils.truncate(comic.getCoverDate(),
                                        Calendar.DAY_OF_MONTH),
                     DateUtils.truncate(result.getCoverDate(),
                                        Calendar.DAY_OF_MONTH));
    }
    ...
    public void testIssueNumberCanBeUpdated() {
        String issueno = comic.getIssueNumber()
                              .substring(1);
    ...
    public void testSummaryCanBeUpdated() {
        String summary = comic.getSummary()
                              .substring(1);
    ...
    public void testCharacters() {
        assertEquals(1,
                     comic.getCharacterCount());
    }

    @Test
    public void testLocations() {
        assertEquals(3,
                     comic.getLocationCount());
    }
    ...
    public void testComicsReturnTheirBlockedPageCount() {
        Comic result = repository.findById(TEST_COMIC_WITH_BLOCKED_PAGES)
                                 .get();

        assertEquals(2,
                     result.getBlockedPageCount());
    }

    @Test
    public void testComicsReturnTheirDeletedPageCount() {
        Comic result = repository.findById(TEST_COMIC_WITH_DELETED_PAGES)
                                 .get();

        assertEquals(3,
                     result.getDeletedPageCount());
    }

    @Test
    public void testComicReturnWithTheirScanType() {
        Comic result = repository.findById(TEST_COMIC)
                                 .get();
    ...
    public void testComicScanTypeCanBeChanged() {
        ScanType scanType = scanTypeRepository.findById(2L)
                                              .get();

        Comic record = repository.findById(TEST_COMIC)
                                 .get();
    ...
    public void testComicFormatCanBeChanged() {
        ComicFormat format = comicFormatRepository.findById(2L)
                                                  .get();
    ...
    public void testComicsReturnWithSortName() {
        ...
        assertEquals(TEST_COMIC_SORT_NAME,
                     result.getSortName());
    }

...
public class ComicTest {
    ...
    public void setUp()
        ...
        this.page = new Page(TEST_PAGE_FILENAME,
                             TEST_IMAGE_CONTENT,
                             pageType);
    }
    ...
    public void testGetFilenameWithoutExtension() {
        ...
        assertEquals(TEST_FILENAME_WITHOUT_EXTENSION,
                     this.comic.getFilenameWithoutExtension());
    }
    ...
    public void testBlockDuplicateStoryArc() {
        ...
        assertEquals(1,
                     this.comic.getStoryArcCount());
        assertEquals(TEST_STORY_ARC_NAME,
                     this.comic.getStoryArc(0));
    ...
    public void testComicVineId() {
        ...
        assertEquals(TEST_COMIC_VINE_ID,
                     this.comic.getComicVineId());
    }
    ...
    public void testComicVineURL() {
        ...
        assertEquals(TEST_COMIC_VINE_URL,
                     this.comic.getComicVineURL());
    }

    @Test
    public void testArchiveType() {
        this.comic.archiveType = ArchiveType.CBZ;
        assertEquals(ArchiveType.CBZ,
    ...
    public void testPageCount() {
        assertEquals(this.comic.pages.size(),
                     this.comic.getPageCount());
        for (int index = 0;
             index < this.comic.pages.size();
             index++) {
            assertSame(this.comic.pages.get(index),
                       this.comic.getPage(index));
        }
    }

    @Test
    public void testPages() {
        assertSame(this.comic.pages,
                   this.comic.getPages());
    }

    @Test
    public void testGetStoryArcs() {
        assertSame(this.comic.storyArcs,
                   this.comic.getStoryArcs());
    }

    @Test
    public void testStoryArcs() {
        assertEquals(this.comic.storyArcs.size(),
                     this.comic.getStoryArcCount());
        for (int index = 0;
             index < this.comic.storyArcs.size();
             index++) {
            assertSame(this.comic.storyArcs.get(index),
                       this.comic.getStoryArc(index));
        }
    }
    ...
    public void testDuplicateCharacter() {
        ...
        assertEquals(1,
                     this.comic.getCharacterCount());
        assertEquals(TEST_CHARACTER,
                     this.comic.getCharacter(0));
    }
    ...
    public void testIssueNumber() {
        ...
        assertEquals(TEST_ISSUE_NUMBER,
    ...
    public void testMultipleCharacters() {
        ...
        assertEquals(TEST_CHARACTER,
                     this.comic.getCharacter(0));
        assertEquals(secondCharacter,
                     this.comic.getCharacter(1));
    }
    ...
    public void testMultipleLocations() {
        ...
        assertEquals(TEST_LOCATION,
                     this.comic.getLocation(0));
        assertEquals(secondLocation,
                     this.comic.getLocation(1));
    }
    ...
    public void testMultipleStoryArcs() {
        ...
        assertEquals(TEST_STORY_ARC_NAME,
                     this.comic.getStoryArc(0));
        assertEquals(otherStoryArc,
                     this.comic.getStoryArc(1));
    }
    ...
    public void testMultipleTeams() {
        ...
        assertEquals(2,
                     this.comic.getTeamCount());
        assertEquals(TEST_TEAM,
                     this.comic.getTeam(0));
        assertEquals(secondTeamName,
                     this.comic.getTeam(1));
    }
    ...
    public void testSummary() {
        ...
        assertEquals(TEST_SUMMARY,
                     this.comic.getSummary());
    }
    ...
    public void testGetCover() {
        this.comic.setFilename(TEST_FILENAME);
        this.comic.addPage(0,
                           this.page);
        Page cover = this.comic.getCover();
        assertNotNull(cover);
        assertSame(this.comic.getPage(0),
                   cover);
    }
    ...
    public void testGetYearPublishedWhenCoverDateIsNull() {
        this.comic.setCoverDate(null);
        assertEquals(0,
                     this.comic.getYearPublished());
    }

    @Test
    public void testGetYearPublished() {
        this.comic.setCoverDate(TEST_DATE);
        assertEquals(TEST_DATE.getYear() + 1900,
                     this.comic.getYearPublished());
    }

    @Test
    public void testIsMissingForNonexistingComic()
            throws
            IOException {
    ...
    public void testHasPageWithFilenameForMissingPage() {
        ...
        comic.addPage(0,
                      page);
        assertFalse(comic.hasPageWithFilename(comic.getCover()
                                                   .getFilename() + "-nope"));
    }
    ...
    public void testHashPageWithFilename() {
        ...
        comic.addPage(0,
                      page);
        assertTrue(comic.hasPageWithFilename(comic.getCover()
                                                  .getFilename()));
    }
    ...
    public void testGetPageWithFilenameForMissingPage() {
        ...
        comic.addPage(0,
                      page);
        assertNull(comic.getPageWithFilename(comic.getCover()
                                                  .getFilename() + "-nope"));
    }
    ...
    public void testGetPageWithFilename() {
        ...
        comic.addPage(0,
                      page);
        Page result = comic.getPageWithFilename(comic.getCover()
                                                     .getFilename());

...
public class ComicVineGetIssueDetailsActionTest {
  ...
  private static final String TEST_ISSUE_ID = "282568";
  ...
  @InjectMocks private ComicVineGetIssueDetailsAction getIssueDetailsAction;
  ...
  public void testExecuteMissingIssueId() throws ScrapingException {
    getIssueDetailsAction.setIssueId("");
    getIssueDetailsAction.execute();
  }

...
@SpringBootTest(classes = {ComicVineResponseAdaptor.class, ObjectMapper.class})
public class ComicVineResponseAdaptorTest {
  private static final byte[] TEST_RESPONSE_NOT_JSON =
  ...
  public void testCheckForErrorsWithNonJSON() throws ComicVineAdaptorException {
    adaptor.checkForErrors(TEST_RESPONSE_NOT_JSON);
  }

  @Test(expected = ComicVineAdaptorException.class)
  public void testCheckForErrorsEmptyJSON() throws ComicVineAdaptorException {
    adaptor.checkForErrors(TEST_RESPONSE_EMPTY_JSON);
  }

  @Test(expected = ComicVineAdaptorException.class)
  public void testCheckForErrorsMissingStatusNode() throws ComicVineAdaptorException {
    adaptor.checkForErrors(TEST_RESPONSE_NOT_COMIVINE);
  }

  @Test(expected = ComicVineAdaptorException.class)
  public void testCheckForErrorsWithErrorResponse() throws ComicVineAdaptorException {
    adaptor.checkForErrors(TEST_RESPONSE_WITH_ERROR);
  }

  @Test
  public void testCheckForErrors() throws ComicVineAdaptorException {

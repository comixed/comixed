...
@Log4j2
public class ComicVineScrapeComicAction
  ...
  @Autowired private ObjectFactory<ComicVineGetIssueDetailsAction> issueDetailsActionObjectFactory;
  ...
  private ComicVineIssue getIssueDetails() throws ScrapingException {
    ...
    final ComicVineGetIssueDetailsAction getIssueDetails =

...
import org.comixed.controller.opds.OPDSBookmarkController;
...
public class OPDSBookmarkControllerTest {
    ...
    @InjectMocks
    private OPDSBookmarkController controller;
    ...
    public void testBookmarkNotFound() throws ComicException
    {
        ...
        BDDMockito.given(controller.getBookmark(DOC_ID)).willThrow(new ComicException(EXPECTED_MESSAGE));
    }

...
public class ImportExportControllerTest {
    ...
    @InjectMocks private ImportExportController controller;
    ...
    @Mock private BlockedPageHashRepository blockedPageRepository;
    @Mock Iterable<BlockedPageHash> blockedPageList;
    @Mock private LastReadDatesRepository lastReadDatesRepository;
    @Mock private List<LastReadDate> lastReadDatesList;
    @Mock private ComicVineIssueRepository comicVineIssueRepository;
    @Mock private List<ComicVineIssue> comicVineIssueList;
    @Mock private ComicVinePublisherRepository comicVinePublisherRepository;
    @Mock private List<ComicVinePublisher> comicVinePublisherList;
    @Mock private ComicVineVolumeQueryCacheRepository comicVineVolumeQueryCacheRepository;
    @Mock private List<ComicVineVolumeQueryCacheEntry> comicVineVolumeQueryCacheList;
    @Mock private ComicVineVolumeRepository comicVineVolumeRepository;
    @Mock private List<ComicVineVolume> comicVineVolumeList;
    @Mock private ZipArchiveAdaptor zipArchiveAdaptor;
    ...
    public void testExportData()
        ...
        assertSame(TEST_ENCODED_CONTENT.length,
                   results.length);
        ...
        Mockito.verify(userRepository,
                       Mockito.times(1))
               .findAll();
        Mockito.verify(blockedPageRepository,
                       Mockito.times(1))
               .findAll();
        ...
        Mockito.verify(comicVineIssueRepository,
                       Mockito.times(1))
               .findAll();
        Mockito.verify(comicVinePublisherRepository,
                       Mockito.times(1))
               .findAll();
        Mockito.verify(comicVineVolumeQueryCacheRepository,
                       Mockito.times(1))
               .findAll();
        Mockito.verify(comicVineIssueRepository,
                       Mockito.times(1))

...
import static org.comixedproject.messaging.comicbooks.PublishAddComicBooksStatusAction.ADD_COMIC_BOOK_STATE_TOPIC;
...
public class PublishAddComicBooksStatusActionTest {
  private static final String TEST_STATUS_AS_JSON = "The status as JSON";

  @InjectMocks private PublishAddComicBooksStatusAction action;
  @Mock private SimpMessagingTemplate messagingTemplate;
  @Mock private ObjectMapper objectMapper;
  @Mock private ObjectWriter objectWriter;
  @Mock private AddComicBooksStatus status;
  ...
  public void testPublish() throws PublishingException, JsonProcessingException {
    ...
    Mockito.verify(messagingTemplate, Mockito.times(1))
        .convertAndSend(ADD_COMIC_BOOK_STATE_TOPIC, TEST_STATUS_AS_JSON);
    Mockito.verify(messagingTemplate, Mockito.times(1))
        .convertAndSend(ADD_COMIC_BOOK_STATE_TOPIC, TEST_STATUS_AS_JSON);
  }
}

...
export class ComicService {
  ...
  import_files_into_library(filenames: string[],
    delete_blocked_pages: boolean,
    ignore_metadata: boolean): Observable<any> {
  ...
  scrape_comic_details_for(api_key: string,
    volume: number,
    issue_number: string,
    skip_cache: boolean): Observable<any> {
    const params = new HttpParams()
  ...
  scrape_and_save_comic_details(api_key: string,
    comic_id: number,
    issue_id: number,
    skip_cache: boolean): Observable<any> {
    const params = new HttpParams()

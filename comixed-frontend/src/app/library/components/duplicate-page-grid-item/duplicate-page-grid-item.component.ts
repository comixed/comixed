...
@Component({
  selector: 'app-duplicate-page-grid-item',
  templateUrl: './duplicate-page-grid-item.component.html',
  styleUrls: ['./duplicate-page-grid-item.component.scss']
})
export class DuplicatePageGridItemComponent implements OnInit {

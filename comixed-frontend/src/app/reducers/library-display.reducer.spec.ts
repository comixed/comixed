...
describe('libraryDisplayReducer', () => {
  ...
  describe('when setting the layout', () => {
    ...
    it('sets the layout to grid', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewLayout({ layout: 'grid' })
      );
      expect(state.layout).toEqual('grid');
    });
  });
  ...
  describe('when setting the comic list sort', () => {
    it('sets the sort field to the volume', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewSort({ sort_field: 'volume' })
      );
    ...
    it('sets the sort field to the issue number', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewSort({ sort_field: 'issue_number' })
      );
    ...
    it('sets the sort field to the added date', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewSort({ sort_field: 'added_date' })
      );
      expect(state.sort_field).toEqual('added_date');
    });
    ...
    it('sets the sort field to the cover date', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewSort({ sort_field: 'cover_date' })
      );
    ...
    it('sets the sort field to the last read date', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewSort({ sort_field: 'last_read_date' })
      );
  ...
  describe('when setting the number of rows', () => {
    it('sets the number of rows to 10', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewRows({ rows: 10 })
      );
      expect(state.rows).toEqual(10);
    });
    ...
    it('sets the number of rows to 10', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewRows({ rows: 25 })
      );
    ...
    it('sets the number of rows to 10', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewRows({ rows: 50 })
      );
    ...
    it('sets the number of rows to 10', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewRows({ rows: 100 })
      );
  ...
  describe('when setting the cover size', () => {
    it('accepts values within the allowed range', () => {
      ...
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewCoverSize({ cover_size: size })
      );
  ...
  describe('when setting using the same height', () => {
    it('sets the value to on', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewUseSameHeight({ same_height: true })
      );
      expect(state.same_height).toBeTruthy();
    });
    ...
    it('sets the value to off', () => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.SetLibraryViewUseSameHeight({ same_height: false })
      );
  ...
  describe('when a user logs in', () => {
    ...
    it('sets the layout', () => {
      expect(state.layout).toEqual(
        user.preferences.find(pref => pref.name === 'library_display_layout')
          .value
      );
    });

    it('sets the sort field', () => {
      expect(state.sort_field).toEqual(
        user.preferences.find(
          pref => pref.name === 'library_display_sort_field'
        ).value
      );
    });

    it('sets the comic file sort field', () => {
      expect(state.comic_file_sort_field).toEqual(
        user.preferences.find((pref: Preference) => {
    ...
    it('sets the rows', () => {
      expect(state.rows).toEqual(
        parseInt(
          user.preferences.find(pref => pref.name === 'library_display_rows')
            .value,
          10
        )
      );
    ...
    it('sets the cover size', () => {
      expect(state.cover_size).toEqual(
        parseInt(
          user.preferences.find(
            pref => pref.name === 'library_display_cover_size'
          ).value,
          10
        )
      );
  ...
  describe('when a user logs out', () => {
    beforeEach(() => {
      state = libraryDisplayReducer(
        state,
        new DisplayActions.LibraryViewLoadUserOptions({ user: null })
      );
    });

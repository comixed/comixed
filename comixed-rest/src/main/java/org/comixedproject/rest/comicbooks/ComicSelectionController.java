...
/**
 * <code>ComicSelectionController</code> provides REST APIs for working with selections made by
 * users.
 *
...
@RestController
@Log4j2
public class ComicSelectionController {
  ...
  public List<Long> getAllSelections(final HttpSession session) throws ComicSelectionException {

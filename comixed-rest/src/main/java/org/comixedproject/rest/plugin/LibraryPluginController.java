...
public class LibraryPluginController {
  ...
  public List<LibraryPlugin> getAllPlugins(final Principal principal) throws PluginException {
  ...
  @JsonView(View.LibraryPluginList.class)
  public void deletePlugin(@PathVariable("pluginId") final long id) throws PluginException {

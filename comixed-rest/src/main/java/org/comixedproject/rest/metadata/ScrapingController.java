...
public class ScrapingController {
  ...
  public ScrapingIssue loadScrapingIssue(
    ...
    return this.scrapingService.getIssue(sourceId, volume, issue, skipCache);
  }
  ...
  public List<ScrapingVolume> loadScrapingVolumes(
      @PathVariable("sourceId") final Long sourceId,
      @RequestBody() final LoadScrapingVolumesRequest request)
      throws ScrapingException {
    ...
    return this.scrapingService.getVolumes(sourceId, series, maxRecords, skipCache);
  }
  ...
  public Comic scrapeComic(
    ...
    return this.scrapingService.scrapeComic(sourceId, comicId, issueId, skipCache);
  }
}
